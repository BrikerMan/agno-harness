...
| Step | Contents |
| --- | --- |
| [01 Iron rules](01-iron-rules.md) | Five product red lines |
| [02 Shell](02-thread-shell.md) | Titles, four-state sidebar, unread, cross-page HITL recall, Composer |
| [03 Stream and scroll](03-stream-and-scroll.md) | `applyEvent`, `body.order[]`, stick-to-bottom |
| [04 Attach and long-run](04-attach-and-longrun.md) | `/attach`, cursors, ping, idle, long-run |
| [05 Close-out](05-hitl-cards-devtools.md) | HITL / cards / DevTools / checklist |
